...
const EditCalculatorFullTitleBlock = ({
  arrayGoods,
  additionalParameter,
  mainId,
  setIsFetch,
  ...
  const [isStretchOnTheStretcherMin, setIsStretchOnTheStretcherMin] =
    useState(false);
  ...
  return (
    <div className="pricing_calc__edit_item">
      {arrayGoods?.nameUa ? (
        <>
          <div
            className={`pricing_calc__edit_item_title ${
              isOpen ? "pricing_calc__edit_item_title__active" : ""
            }`}
            onClick={() =>
              setCurrentName(
                lang == "Ua" ? arrayGoods.nameUa : arrayGoods.nameRu
              )
            }
          >
          ...
          {isOpen && (
            <div className="pricing_calc_open_goods">
              {arrayGoods?.color.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.color}
                  title={"Color"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-color`}
              ...
              {arrayGoods?.eyelets.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.eyelets}
                  title={"Eyelets"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-eyelets-price`}
              ...
              {arrayGoods?.quality.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.quality}
                  title={"Quality"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-quality`}
              ...
              {arrayGoods?.lamination.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.lamination}
                  title={"Lamination"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-lamination`}
              ...
              {arrayGoods?.poster.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.poster}
                  title={"Poster"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-poster`}
              ...
              {arrayGoods?.solderingOfGates.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.solderingOfGates}
                  title={"SolderingOfGates"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-soldering-of-gates`}
              ...
              {arrayGoods?.solderingPockets.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.solderingPockets}
                  title={"SolderingPockets"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-soldering-pockets`}
              ...
              {arrayGoods?.cutting.length != 0 && (
                <EditCalculatorFullData
                  currentArray={arrayGoods?.cutting}
                  title={"Cutting"}
                  mainId={mainId}
                  setIsFetch={setIsFetch}
                  goodsIndex={goodsIndex}
                  editPath={`${BASE_URL}/update-cutting`}
              ...
              {arrayGoods?.mounting && (
                <EditCalculatorAdditionalParameter
                  ...
                  setIsFetch={setIsFetch}
                  editPath={`${BASE_URL}/update-mounting`}
              ...
              {arrayGoods?.stamp && (
                <EditCalculatorAdditionalParameter
                  ...
                  setIsFetch={setIsFetch}
                  editPath={`${BASE_URL}/update-stamp`}
        ...
        <>
          <>
            ...
            {arrayGoods?.stretchOnTheStretcher && (
              <EditCalculatorAdditionalParameter
                data={arrayGoods?.stretchOnTheStretcher}
                title={"Tension on the stretcher standard price"}
                mainId={mainId}
                setIsFetch={setIsFetch}
                goodsIndex={goodsIndex}
                editPath={`${BASE_URL}/update-stretch-on-the-stretcher`}
            ...
            {arrayGoods?.stretchOnTheStretcherMin && (
              <EditCalculatorAdditionalParameter
                data={arrayGoods?.stretchOnTheStretcherMin}
                title={"Натяжка на подрамник мінімальна ціна"}
                mainId={mainId}
                setIsFetch={setIsFetch}
                goodsIndex={goodsIndex}
                editPath={`${BASE_URL}/update-stretch-on-the-stretcher-min`}
