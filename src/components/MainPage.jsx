                        ...
                        <ul className='services_list'>
                            ...
                            onClick={() => hendlerOpenDesint()} alt="" />
                             ...
                             {isOpenDesing &&
                                ...
                                <p>{t(`The cost of design services`)}</p>
                                </div>
                                }</li>
                            <li 
                            className='services_item'
                            ...
                            <p className='services_name' >{t(`Welding of gates and stuffing of eyelets`)}</p>
                            {isOpenGates &&
                                <div className='modal_services'>
                                 <div
                                 className='close_modal_services'
                                ...
                                <div className='img_wraper'>
                                 ...
                                 <div>
                                    <p>{t(`The Express-Print large-format printing house produces a full cycle of post-print processing`)}</p>
                                    <p>{t(`For banners`)}</p>
                                    <p>{t(`For self-adhesive film`)}</p>
                                    <p>{t(`For paper, this is cutting into posters or lamination`)}</p>
                                 </div>
                                </div>
                                }</li>
                            <li
                            ...
                            onClick={() => hendlerOpenAdversting()}
                             ...
                             <p className='services_name' >{t(`Production of outdoor advertising`)}</p>
                             {isOpenAdversting &&
                                <div className='modal_services'>
                                 <div
                                 className='close_modal_services'
                                ...
                                <div className='img_wraper'>
                                 ...
                                 <div>
                                    <p>{t(`We make any kind of outdoor and indoor advertising`)}</p>
