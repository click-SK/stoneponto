...
export const fetchRegister = createAsyncThunk('auth/fetchRegister', async (params) => {
    const {data} = await fetch('https://server-ponto-print.herokuapp.com/register-user');
    return data
})

export const fetchAuth = createAsyncThunk('auth/fetchAuth', async ({name, password}) => {
    const response = await fetch('https://server-ponto-print.herokuapp.com/login-user', {
        method: 'POST',
        headers: {
...
export const fetchAuthMe = createAsyncThunk('auth/fetchAuthMe', async () => {
    const response = await fetch('https://server-ponto-print.herokuapp.com/get-me', {
        headers: {
...
export const fetchIsAdmin = createAsyncThunk('auth/fetchIsAdmin', async () => {
    const {data} = await fetch('https://server-ponto-print.herokuapp.com/get-me');
    return data.isadmin
})
