...
export const fetchRegister = createAsyncThunk('auth/fetchRegister', async (params) => {
    const {data} = await fetch('http://server.ponto-print.com.ua:4444/register-user');
    return data
})

export const fetchAuth = createAsyncThunk('auth/fetchAuth', async ({name, password}) => {
    const response = await fetch('http://server.ponto-print.com.ua:4444/login-user', {
        method: 'POST',
        headers: {
...
export const fetchAuthMe = createAsyncThunk('auth/fetchAuthMe', async () => {
    const response = await fetch('http://server.ponto-print.com.ua:4444/get-me', {
        headers: {
...
export const fetchIsAdmin = createAsyncThunk('auth/fetchIsAdmin', async () => {
    const {data} = await fetch('http://server.ponto-print.com.ua:4444/get-me');
    return data.isadmin
})
